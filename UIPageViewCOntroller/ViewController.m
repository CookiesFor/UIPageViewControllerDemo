...
- (void)viewDidLoad
{
    ...
    //UIPageViewControllerTransitionStyleScroll scroll动画，平滑的上下滚动
    //UIPageViewControllerTransitionStylePageCurl  翻书动画
    
    //UIPageViewControllerNavigationOrientationVertical 竖直
    //UIPageViewControllerNavigationOrientationHorizontal 水平
...
- (void) createContentPages {
    ...
    for (int i = 1; i < 11; i++){
        NSString *contentString = @"http://www.baidu.com";
